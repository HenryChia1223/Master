...
namespace TreeScore.treescore
{
	public class tree_score
	{
		...
		public static double Node_Evaluation(int num_my_board, int num_op_board, int num_my_hand, int num_op_hand,
			int num_my_hero, int num_op_hero, int num_my_deck, int num_op_deck, int num_remaining_mana)
		{
